...
test.describe('Admin Workflows', () => {
  ...
  test.describe('Link Management', () => {
    ...
    test('should create a new affiliate link', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="link-row"]').last()
    ...
    test('should edit an existing affiliate link', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="link-row"]').first()
    ...
    test('should delete an affiliate link', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="link-row"]')).toHaveCount(
        initialRows - 1
      );
    });
    ...
    test('should validate form fields', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="affiliate-url-error"]')
      ).toBeVisible();
  ...
  test.describe('Analytics Dashboard', () => {
    ...
    test('should display analytics dashboard', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="metrics-summary"]')
      ).toBeVisible();
      ...
      await expect(
        page.locator('[data-testid="performance-table"]')
      ).toBeVisible();
    });
  ...
  test.describe('Bulk Operations', () => {
    ...
    test('should select multiple links for bulk operations', async ({
      page,
    }) => {
