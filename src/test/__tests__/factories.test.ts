...
describe('createMockDataset', () => {
  ...
  it('should have links associated with categories', () => {
    ...
    expect(dataset.links.every(link => categoryIds.includes(link.category.id))).toBe(true)
  })
  ...
  it('should have click events associated with links', () => {
    ...
    expect(dataset.clickEvents.every(event => linkIds.includes(event.linkId))).toBe(true)
  })
