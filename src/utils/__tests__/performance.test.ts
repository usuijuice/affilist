...
describe('Performance Monitor', () => {
  ...
  describe('Basic Timing', () => {
    ...
    it('should handle ending timing for non-existent operation', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('No timing started for: non-existent');
  ...
  describe('Async Measurement', () => {
    ...
    it('should measure async operations that throw', async () => {
      ...
      await expect(measureAsync('async-error', asyncOperation)).rejects.toThrow('Test error');
  ...
  describe('Sync Measurement', () => {
    ...
    it('should measure sync operations that throw', () => {
      ...
      expect(() => measureSync('sync-error', syncOperation)).toThrow('Sync error');
  ...
  describe('Performance Budget', () => {
    beforeEach(() => {
      ...
      mockPerformance.now
        .mockReturnValueOnce(1000).mockReturnValueOnce(1200) // fast-operation: 200ms
        .mockReturnValueOnce(2000).mockReturnValueOnce(2800); // slow-operation: 800ms
    ...
    it('should fail when metrics exceed budget', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        expect.stringContaining('Performance budget exceeded for fast-operation')
      );
...
describe('Performance Integration', () => {
  ...
  it('should handle performance monitoring lifecycle', () => {
    ...
    mockPerformance.now
      ...
      .mockReturnValueOnce(2000).mockReturnValueOnce(2300);
