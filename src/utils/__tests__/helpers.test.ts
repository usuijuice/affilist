...
describe('filterAffiliateLinks', () => {
  ...
  it('should filter by commission rate range', () => {
    ...
    expect(
      result.every(
        (link) =>
          (link.commissionRate || 0) >= 15 && (link.commissionRate || 0) <= 25
      )
    ).toBe(true);
  });
...
describe('highlightSearchText', () => {
  it('should highlight matching text with mark tags', () => {
    ...
    expect(result).toBe(
      'Hello <mark class="bg-yellow-200 px-1 rounded">world</mark>'
    );
  });
  ...
  it('should highlight multiple matches', () => {
    ...
    expect(result).toBe(
      'Hello <mark class="bg-yellow-200 px-1 rounded">world</mark>, wonderful <mark class="bg-yellow-200 px-1 rounded">world</mark>'
    );
  });
  ...
  it('should escape special regex characters', () => {
    ...
    expect(result).toBe(
      'Price: <mark class="bg-yellow-200 px-1 rounded">$10.99</mark>'
    );
  });
  ...
  it('should handle parentheses', () => {
    ...
    expect(result).toBe(
      'Test <mark class="bg-yellow-200 px-1 rounded">(special)</mark> case'
    );
  });
