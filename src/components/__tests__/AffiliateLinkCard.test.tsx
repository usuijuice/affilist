...
describe('AffiliateLinkCard', () => {
  ...
  it('renders affiliate link information correctly', () => {
    ...
    expect(screen.getByText('This is a test description for the affiliate link')).toBeInTheDocument();
  ...
  it('displays category badge with correct color', () => {
    ...
    const categoryBadge = categoryBadges.find(el => el.tagName === 'SPAN' && el.classList.contains('rounded-full'));
  ...
  it('renders tags correctly and limits display to 3', () => {
    ...
    render(<AffiliateLinkCard link={linkWithManyTags} onLinkClick={mockOnLinkClick} />);
  ...
  it('displays featured badge when featured prop is true', () => {
    render(<AffiliateLinkCard link={defaultLink} onLinkClick={mockOnLinkClick} featured={true} />);
  ...
  it('displays featured badge when link.featured is true', () => {
    ...
    render(<AffiliateLinkCard link={featuredLink} onLinkClick={mockOnLinkClick} />);
  ...
  it('does not display featured badge when not featured', () => {
    ...
    render(<AffiliateLinkCard link={regularLink} onLinkClick={mockOnLinkClick} />);
  ...
  it('renders placeholder when no imageUrl is provided', () => {
    ...
    render(<AffiliateLinkCard link={linkWithoutImage} onLinkClick={mockOnLinkClick} />);
  ...
  it('formats commission rate correctly', () => {
    const linkWithCommission = createMockAffiliateLink({ commissionRate: 25.75 });
    render(<AffiliateLinkCard link={linkWithCommission} onLinkClick={mockOnLinkClick} />);

    expect(screen.getByText('25.75% commission')).toBeInTheDocument();
  });

  it('does not display commission when not provided', () => {
    const linkWithoutCommission = createMockAffiliateLink({ commissionRate: undefined });
    render(<AffiliateLinkCard link={linkWithoutCommission} onLinkClick={mockOnLinkClick} />);
  ...
  it('formats click count correctly for large numbers', () => {
    ...
    render(<AffiliateLinkCard link={linkWithManyClicks} onLinkClick={mockOnLinkClick} />);
  ...
  it('formats click count correctly for small numbers', () => {
    ...
    render(<AffiliateLinkCard link={linkWithFewClicks} onLinkClick={mockOnLinkClick} />);
  ...
  it('handles empty tags array', () => {
    ...
    render(<AffiliateLinkCard link={linkWithoutTags} onLinkClick={mockOnLinkClick} />);
