...
type SortField = 'title' | 'category' | 'status' | 'clickCount' | 'featured' | 'updatedAt';
...
export function LinkManagementTable({ links, onEdit, onDelete, isLoading = false }: LinkManagementTableProps) {
  ...
  const categories = useMemo(() => {
    const uniqueCategories = Array.from(new Set(links.map(link => link.category.name)));
  ...
  const filteredAndSortedLinks = useMemo(() => {
    ...
    if (filterCategory !== 'all') {
      filtered = filtered.filter(link => link.category.name === filterCategory);
    }
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div className="mt-3 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mt-2">Delete Link</h3>
        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div className="mt-3 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mt-2">Delete Multiple Links</h3>
              <div className="mt-2 px-7 py-3">
                <p className="text-sm text-gray-500">
                  Are you sure you want to delete {selectedLinks.size} selected link{selectedLinks.size !== 1 ? 's' : ''}? This action cannot be undone.
                </p>
              </div>
              <div className="items-center px-4 py-3">
                <button
