...
import { Layout, ErrorBoundary, ToastProvider, LoadingSpinner } from './components';
...
const FeaturedPage = lazy(() => import('./pages/FeaturedPage').then(module => ({ default: module.FeaturedPage })));
