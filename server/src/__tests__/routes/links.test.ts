...
describe('Links API Routes', () => {
  ...
  describe('GET /api/links', () => {
    it('should return paginated affiliate links with default parameters', async () => {
      ...
      const response = await request(app).get('/api/links').expect(200);
    ...
    it('should handle search filtering', async () => {
      ...
      await request(app).get('/api/links?search=test%20query').expect(200);
    ...
    it('should handle featured filtering', async () => {
      ...
      await request(app).get('/api/links?featured=true').expect(200);
    ...
    it('should handle tag filtering', async () => {
      ...
      await request(app).get('/api/links?tags=tag1&tags=tag2').expect(200);
    ...
    it('should validate and limit pagination parameters', async () => {
      ...
      await request(app).get('/api/links?limit=200&offset=-10').expect(200);
  ...
  describe('GET /api/links/featured', () => {
    it('should return featured links with default limit', async () => {
      ...
      vi.mocked(AffiliateLinkModel.getFeatured).mockResolvedValue(
        featuredLinks
      );
    ...
    it('should handle custom limit', async () => {
      ...
      await request(app).get('/api/links/featured?limit=5').expect(200);
    ...
    it('should limit maximum featured links', async () => {
      ...
      await request(app).get('/api/links/featured?limit=100').expect(200);
  ...
  describe('GET /api/links/popular', () => {
    it('should return popular links with default limit', async () => {
      ...
      const response = await request(app).get('/api/links/popular').expect(200);
    ...
    it('should handle custom limit', async () => {
      ...
      await request(app).get('/api/links/popular?limit=20').expect(200);
    ...
    it('should limit maximum popular links', async () => {
      ...
      await request(app).get('/api/links/popular?limit=100').expect(200);
